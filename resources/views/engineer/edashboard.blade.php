                                        ...
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <ul class="list-inline">
                                                    <li>Unique ID: <span class="text-base">UD003054</span></li>
                                                    <li>Last Login: <span class="text-base">15 Feb, 2019 01:02 PM</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="nk-block-head-content">
                                            <a href="{{ url('/profile') }}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>View Profile</span></a>
                                        ...
                                        <div class="card-aside-wrap">
                                            <div class="card-content">
                                                <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" href="#"><em class="icon ni ni-user-circle"></em><span>Account</span></a>
                                                    </li>
                                                        ...
                                                        <div class="profile-ud-list">
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    ...
                                                                    <span class="profile-ud-value">UD003054</span>
                                                                </div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    <span class="profile-ud-label">Approval status :</span>
                                                                    <span class="profile-ud-value">Pending</span>
                                                                </div>
                                                            </div>                   
                                                        </div><!-- .profile-ud-list -->
                                                    </div><!-- .nk-block -->
