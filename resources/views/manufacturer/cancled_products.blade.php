                                                    ...
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="{{ url('/new_product') }}"><span>Add New</span></a></li>
                                                ...
                                                <table class="table table-orders">
                                                    <thead class="tb-odr-head">
                                                        <tr class="tb-odr-item">
                                                            ...
                                                            <span class="tb-odr-id">Product Name</span>
                                                            <span class="tb-odr-date d-none d-md-inline-block">Category</span>
                                                            </th>
                                                            <th class="tb-odr-amount">
                                                        <span class="tb-odr-total">Certification</span>
                                                                
                                                            </th>
                                                            <th class="tb-odr-amount">
                                                                <span class="tb-odr-total">Serial Number</span>
                                                    ...
                                                    <tbody class="tb-odr-body">
                                                        <tr class="tb-odr-item">
                                                            <td class="tb-odr-info">
                                                                <span class="tb-odr-id"><a href="html/invoice-details.html">{{$data->name}}</a></span>
                                                                <span class="tb-odr-date">{{$data->category}}</span>
                                                            </td>

                                                            <td class="tb-odr-info">
                                                                <span class="tb-odr-id"><a href="html/invoice-details.html">{{$data->certification}}</a></span>
                                                                
                                                            </td>
                                                            <td class="tb-odr-amount">
                                                                <span class="tb-odr-total">
                                                                    <span class="amount">{{$data->serial}}</span>
                                                                </span>
                                                                ...
                                                                <span class="tb-odr-status">
                                                                    <span class="badge badge-dot badge-danger">Canceled</span>
                                                                </span>
