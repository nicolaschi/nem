                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                <li class="nk-menu-item">
                                    <a href="{{ url('/mdashboard') }}" class="nk-menu-link">
                                ...
                                <li class="nk-menu-item has-sub">
                                    <a href="#" class="nk-menu-link nk-menu-toggle">
                                        ...
                                        <span class="nk-menu-text"> View products</span>
                                    </a> 
                                    <ul class="nk-menu-sub">

                                    <li class="nk-menu-item">
                                            <a href="{{ url('/courses') }}" class="nk-menu-link"><span class="nk-menu-text">All Product</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/active_product') }}" class="nk-menu-link"><span class="nk-menu-text">Active Product</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/pending_product') }}" class="nk-menu-link"><span class="nk-menu-text">Pending product</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('/cancled_product') }}" class="nk-menu-link"><span class="nk-menu-text">Canceled product</span></a>
                                        </li>
                                    </ul> 

                                <li class="nk-menu-item">
                                    <a href="{{ url('/new_product') }}" class="nk-menu-link">
                                ...
                                <li class="nk-menu-item">
                                    <a href="{{ url('/upload_product') }}" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-file-fill"></em></span>
                                        <span class="nk-menu-text">Upload Product</span>
                                    </a>
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-item">
                                    <a href="{{ url('/mprofile') }}" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-user-fill"></em></span>
                                        <span class="nk-menu-text">Profile</span>
                                    </a>
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-item">
                                    <a href="{{ url('/mchangepass')}}" class="nk-menu-link">
                                    ...
                                    <li class="dropdown user-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="{{ url ('/mprofile')}}"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a></li>
                                                    
                                                    <li><a href="{{ url ('/mchangepass')}}"><em class="icon ni ni-setting-alt"></em><span>Change Password</span></a></li>
